...
/** Base trait for all CLI commands
  *
  * Each command implements this trait and provides its execution logic.
  * This allows for better separation of concerns, easier testing, and
...
object CommandHelpers {
    ...
    /** Parse UTxO reference string (TX_HASH:OUTPUT_INDEX)
      *
      * @param utxo UTxO reference string
      * @return Either error message or (txHash, outputIndex)
      */
