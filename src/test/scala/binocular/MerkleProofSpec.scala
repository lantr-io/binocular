...
class MerkleProofSpec extends FunSuite {
  ...
  test("merkle tree with 4 transactions") {
    ...
    for (i <- 0 until 4) {
      ...
      assertEquals(proof.length, 2, s"Proof length should be 2 for tx at index $i") // log2(4) = 2 levels
  ...
  test("coinbase transaction hash calculation") {
    ...
    val simpleCoinbaseRaw = hex""
